package com.example.foodapp_fullstack.presentation.screens.CategoryScreen
...
import com.example.foodapp_fullstack.presentation.components.FilterRow
import com.example.foodapp_fullstack.presentation.components.HomeScreenCards
@Composable
fun ChineseCategoryScreen(
    navController: NavController
) {
    ChineseCategoryCard(navController)
}


@Composable
fun ChineseCategoryCard(
    navController: NavController
) {
